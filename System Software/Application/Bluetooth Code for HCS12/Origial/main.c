...
// initalizationz
  ...
  while (1)
  {
       ...
       */
       ...
       if (data[i] != 0) {
        //As long as the phone isn't straigt, MOVE                
        PTT = 0x0F;      
        PWMDTY4=100;      // set 0% duty cycle, (4=>right wheel/5=>left wheel)
        PWMDTY5=100;  
        PWMDTY6=100;      // set 0% duty cycle, (4=>right wheel/5=>left wheel)
        PWMDTY7=100;                          
        PWME = 0xF0; 
       }
 
      else {
        //WHen the phone is straight...
        //STOP WHEELS
        PTT = 0;
        PWMDTY4 = 25;
        PWMDTY6 = 25;        
